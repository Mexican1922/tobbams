      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-16">
        <div className="bg-primary rounded-[8px] px-8 md:px-16 py-10 md:py-12 w-full max-w-[1134px] mx-auto flex flex-col items-center justify-center gap-6 shadow-lg">
          <div className="text-center flex flex-col items-center gap-2">
            <p className="text-white text-[16px] md:text-[18px] font-normal font-[Nunito_Sans] leading-relaxed max-w-[600px]">
              Want to accelerate professional growth and development at your organisation?
            </p>
            <h2
              id="cta-heading"
              className="font-[Nunito] font-semibold text-white text-[20px] md:text-[24px]"
            >
              See how we can help.
            </h2>
          </div>
